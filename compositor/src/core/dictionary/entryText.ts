 ...
 * surface, and the quick-fix titles.
 * adapters/vscode/commands/dictionaryDiagnostics.ts owns the prompts,
 * squiggles, and code actions; the wording and the input-validation rule are
 * here, and tested.
 */

import { fold, isWord } from "@earlytexts/corpus";
import type { TildeFusion, UnaccountedWord } from "./scan.ts";
