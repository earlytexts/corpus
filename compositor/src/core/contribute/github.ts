 ...
 * the corpus, and opening and following the pull requests that carry their
 * work back. Declared here as a port the core owns; the REST implementation
 * lives in `adapters/git/github.ts`, the pure `ensureFork` flow written over
 * it in `core/contribute/setup.ts`.
 */
