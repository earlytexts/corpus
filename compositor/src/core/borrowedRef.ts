 ...
 * editions the contributor can borrow, and the reference line that borrows one.
 * A borrowed child (`## <Author.Work.Edition>`) splices another edition's text
 * in place — how collections (ETSS, FD, HE) share text with the works they
 * gather. The editor layer (commands/insertBorrowedRef.ts) turns these into a
