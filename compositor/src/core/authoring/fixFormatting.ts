 ...
 * reports the tally. The editor layer
 * (adapters/vscode/commands/fixFormatting.ts) wraps this in a progress
 * notification and surfaces the count; the watcher revalidates once the writes
 * land.
 */
