 ...
 * anything to compare, which is the base, where do the files live) is made
 * here and handed back as one `CompareOutcome`. The editor layer
 * (adapters/vscode/commands/compareEditions.ts) supplies the picks and renders
 * the outcome — opening the native diff or explaining why it cannot.
 *
...
import { editionPath, type TreeNode } from "../catalogue/nodes.ts";
