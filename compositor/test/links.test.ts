/**
 * The external authority links (../src/core/links.ts): which links an author or
 * edition has, where each resolves to, and the `viewItem` tokens the tree marks
 * a node with so its context menu offers only the links that entity records.
 *
